...
import { type Category } from '../../redux/todo';
...
const MenuAddTodo: React.FC<MenuAddTodoProps> = ({ isSelectedCategory, setIsMenuAddTodoOpen }) => {
  ...
  const validationSchema = Yup.object().shape({
    title: Yup.string()
      ...
      .max(50, 'Название задачи должно быть не более 50 символов'),
